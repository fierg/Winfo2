...
public class Puzzle {
	...
	private final int[][] SOLUTION = {{1,2,3},{8,0,4},{7,6,5}};
	...
	/**
	 * swaps two Tiles. Doesn't check if one of them is 0 or out of bounds, use moveTile() for public usage
	 * @param x the x coordinate to be swapped
	 * @param y the y coordinate to be swapped
	 * @param x2 the x coordinate to swap with
	 * @param y2 the y coordinate to swap with
	 */
	 ...
	 * @return returns true if all tiles are in the correct order (1,2,3,8,0,4,7,6,5)
	 */
